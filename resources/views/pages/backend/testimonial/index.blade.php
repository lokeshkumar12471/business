<x-app-layout>
    <h1>Testimonial</h1>
    <a href="{{ route('admin.testimonial.create') }}" class="container flex justify-center">
                        ...
                        <tbody class="bg-white">
                            @foreach ($item as $items)
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                        <img src="{{ asset('Upload/images/testimonial/' . $items->image) }}"
                                            width="70px">
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.testimonial.view', $items->id) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.testimonial.edit', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded">
                                            <img
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.testimonial.delete', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded"

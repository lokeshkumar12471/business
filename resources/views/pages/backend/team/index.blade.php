<x-app-layout>
    <h1>Team</h1>
    <a href="{{ route('admin.team.create') }}" class="container flex justify-center">
                        ...
                        <tbody class="bg-white">
                            @foreach ($item as $items)
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                        <img src="{{ asset('Upload/images/team/' . $items->image) }}" width="70px"
                                            height="100px" alt="">
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.team.view', $items->id) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.team.edit', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded">
                                            <img
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.team.delete', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded"

<x-app-layout>
    <h1>About Us</h1>
    <br /><br />
    <a href="{{ route('admin.about.create') }}" class="container flex justify-center">
                        ...
                        <tbody class="bg-white">
                            @foreach ($item as $items)
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                        <img src="{{ asset('Upload/images/about/' . $items->image) }}" width="70px"
                                            height="100px" alt="">
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.about.view', $items->id) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.about.edit', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded">
                                            <img
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.about.delete', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded"

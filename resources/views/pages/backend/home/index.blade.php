<x-app-layout>
    <h1>Home</h1>
    <a href="{{ route('admin.home.create') }}" class="container flex justify-center">
                        ...
                        <tbody class="bg-white">
                            @foreach ($item as $items)
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.home.view', $items->id) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.home.edit', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded">
                                            <img
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.home.delete', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded"
